...
namespace CSML
{
    public class Complex
    {
        ...
        public static Complex phi(Complex z, Complex a, Complex b, Complex c, Complex d)
        {
            return (a * z + b) / (c * z + d);
        }

        public static Complex inversePhi(Complex z, Complex a, Complex b, Complex c, Complex d)
        {
            return (d * z - b) / (-c * z + a);
        }

        public static Complex DistanceToCoordinate(Double distance)
        {
            return new Complex((Math.Pow(Math.E, distance) - 1) / (Math.Pow(Math.E, distance) + 1), 0);
        }

        public static Complex GetNormW(Complex num)
        {
            return new Complex(Math.Cos(Math.Atan2(num.im, num.re)), Math.Sin(Math.Atan2(num.im, num.re)));
        }
